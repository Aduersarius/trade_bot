    ...
    for epoch in range(10):
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(
                ...
                active=6,
                repeat=1),
            on_trace_ready=torch.profiler.tensorboard_trace_handler("C:\\Users\\emire\\vs_repositories\\trade_bot\\runs"),) as p:
                ...
                if len(state_memory) == memory_size:
                    ...
                    if global_step % train_freq == 0:
                        ...
                        for i in range(memory_size)[::batch_size]:
                            ...
                            loss = criterion(input=q_eval, target=q_target[0].view(-1, 1))
